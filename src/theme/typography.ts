...
const FONT_SCALE: Record<FontLevel, { xxs: number; xs: number; sm: number; md: number; lg: number; xl: number; xxl: number; '3xl': number; '4xl': number }> = {
  8:  { xxs: 5,  xs: 6,  sm: 7,  md: 8,  lg: 9,  xl: 10, xxl: 12, '3xl': 16, '4xl': 20 },
  9:  { xxs: 6,  xs: 7,  sm: 8,  md: 9,  lg: 10, xl: 11, xxl: 14, '3xl': 18, '4xl': 22 },
  10: { xxs: 6,  xs: 8,  sm: 9,  md: 10, lg: 11, xl: 13, xxl: 15, '3xl': 20, '4xl': 25 },
  11: { xxs: 7,  xs: 9,  sm: 10, md: 11, lg: 12, xl: 14, xxl: 17, '3xl': 22, '4xl': 28 },
  12: { xxs: 8,  xs: 9,  sm: 11, md: 12, lg: 14, xl: 15, xxl: 18, '3xl': 24, '4xl': 30 },
  13: { xxs: 8,  xs: 10, sm: 12, md: 13, lg: 15, xl: 16, xxl: 20, '3xl': 26, '4xl': 32 },
  14: { xxs: 9,  xs: 11, sm: 12, md: 14, lg: 16, xl: 18, xxl: 21, '3xl': 28, '4xl': 35 },
  15: { xxs: 10, xs: 12, sm: 13, md: 15, lg: 17, xl: 19, xxl: 23, '3xl': 30, '4xl': 38 },
  16: { xxs: 10, xs: 12, sm: 14, md: 16, lg: 18, xl: 20, xxl: 24, '3xl': 32, '4xl': 40 },
  17: { xxs: 11, xs: 13, sm: 15, md: 17, lg: 19, xl: 21, xxl: 26, '3xl': 34, '4xl': 43 },
  18: { xxs: 12, xs: 14, sm: 16, md: 18, lg: 20, xl: 22, xxl: 28, '3xl': 36, '4xl': 46 },
};
